...
const styles = StyleSheet.create({
  ...
  allocCard: { minWidth: 220, maxWidth: 480, flexGrow: 1, flexShrink: 1, flexBasis: 220, alignItems: 'center' },
  allocClass: { ...typography.small, color: colors.textSecondary, marginBottom: 4, textAlign: 'center' },
  allocPct: { ...typography.h3, color: colors.textPrimary, marginBottom: 6, textAlign: 'center' },
  barTrack: { height: 6, borderRadius: 3, backgroundColor: colors.surfaceAlt, overflow: 'hidden', width: '100%' },
  barFill: { height: 6, borderRadius: 3 },
  allocLimit: { ...typography.caption, color: colors.textMuted, marginTop: 4, textAlign: 'center' },
});
