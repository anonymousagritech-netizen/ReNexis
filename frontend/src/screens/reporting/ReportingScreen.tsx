...
const styles = StyleSheet.create({
  ...
  heatmapTile: { minWidth: 200, maxWidth: 480, flexGrow: 1, flexShrink: 1, flexBasis: 200, borderRadius: 10, padding: spacing.md, borderWidth: 1, borderColor: colors.border, alignItems: 'center' },
  heatmapZone: { ...typography.bodyMedium, color: colors.white, marginBottom: 4, textAlign: 'center' },
  heatmapValue: { ...typography.small, color: colors.white, textAlign: 'center' },
});
